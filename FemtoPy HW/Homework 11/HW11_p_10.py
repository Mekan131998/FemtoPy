# -*- coding: utf-8 -*-
"""
Created on Thu Nov 30 16:49:48 2023
...
phi_w=0.5*GDD0*(om-om0)**2+(TOD0/6)*(om-om0)**3+(FOD0/24)*(om-om0)**4+(QOD0/120)*(om-om0)**5
...
# =============================================================================
#4. I(t) AND ω_ins (t) OF THE OUTPUT PULSE
# =============================================================================
